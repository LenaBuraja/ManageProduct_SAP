sap.ui.define([
	...
	return BaseController.extend("opensap.managepropducts.ManageProducts.controller.Worklist", {
		...
		_getPopover : function () {
			...
			if (!this._oPopover) {
				...
				this._oPopover = sap.ui.xmlfragment(
					"opensap.managepropducts.ManageProducts.view.ResponsivePopover", this
				);
